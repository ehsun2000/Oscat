...
//	@PostMapping("/{cinemaName}/products") (未測試)
//	public ResponseEntity<String> addProductToCinema(@PathVariable String cinemaName,@RequestBody String productName){
//		cinemaService.addProductToCinema(cinemaName, productName);
//		return ResponseEntity.ok("產品已添加到影城:" + cinemaName);
//	}
//	
//	@GetMapping("/{cinemaName}/products") (未測試)
//	public ResponseEntity<List<Product>>getProductByCinema(@PathVariable String cinemaName){
//		List<Product> products = cinemaService.getProductsByCinema(cinemaName);
