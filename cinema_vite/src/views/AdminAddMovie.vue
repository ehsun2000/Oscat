...
const demo1 = () => {
  movie.value = {
    ...
    movieStatus: '下檔',
    director: '姜瑞智',
    writerList: '張芷瑄 / 姜瑞智 / 張志杰',
    actorList:
      '鄭人碩 / 謝欣穎 / 盛鑑 / 高捷 / 龍劭華 / 柯叔元 / 黃尚禾 / 古斌 / 曾莞婷 / 陳竹昇 / 唐振剛 / 吳震亞 / 林道禹',
    plotSummary:
      '《角頭》系列作品不斷警惕世人「今天公祭，明天忘記」、「歹路不可行」。而《角頭-浪流連》則以女性、愛情的角度切入，讓觀眾以不同的視角，卻更加看清這個混沌的角頭世界。 阿慶：「人在江湖身不由己，沒想到連談戀愛都身不由己......」 小淇：「愛上江湖人之後，才知道愛情可以這麼難、這麼苦。」 《角頭-浪流連》故事描述阿慶（鄭人碩 飾演）在北館角頭大哥 仁哥的女兒滿月宴上，偶遇攝影師小淇（謝欣穎 飾演）進而衍生出一段相愛卻不能相守的愛情故事。 身為角頭的阿慶遇到了小淇，原本水火不容的兩人，再一次次的爭吵中發現其實自己最在乎對方。阿慶與小淇相愛、相知、相惜、互相扶持，阿慶為小淇解決困難、小淇在阿慶事業遇到瓶頸時給予鼓勵。但就在此時湳沆的世界在背地裡陷害北館販毒，不僅讓北館深陷危機，仁哥與五虎們相繼誤解阿慶，小淇也因為阿慶受重傷。阿慶分身乏術，痛定思痛決定奮力一搏。',
    releaseDate: '2021-02-05',
    duration: '120',
    classification: '輔導十五級',
    trailerLink: 'https://www.youtube.com/watch?v=_5skNbL4FV8',
    posterImage: '',
    movieStills: [
      {
        stillImageUrl: '',
